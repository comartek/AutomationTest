 ...
 */
public class HtmlElement extends ExtendedWebElement {
    ...
    public void click() {
        ...
        new WebDriverWait(((WrapsDriver) getWrappedElement()).getWrappedDriver(), 5000).until(ExpectedConditions.elementToBeClickable(getWrappedElement())).click();
    }
