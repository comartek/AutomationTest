...
public abstract class ExtendedWebElement implements WrapsElement, Named, WebElement {
    ...
    public void scrollIntoView() {
        try {
            ((JavascriptExecutor) getActiveDriver()).executeScript("arguments[0].scrollIntoView(true);", this);
        } catch (Exception e) {
            //ignored
        }
    }
    ...
    public void blurActiveElement() {
        ((JavascriptExecutor) getActiveDriver()).executeScript("document.activeElement.blur();");
    }
