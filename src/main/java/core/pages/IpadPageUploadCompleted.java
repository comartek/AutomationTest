...
public class IpadPageUploadCompleted extends RosyBasePage {
    @Override
    public void waitUntilLoadingIndicatorIsInvisible(int maxWaitTimeInSeconds) {
        ...
        webDriverWait.ignoring(StaleElementReferenceException.class).until(webDriver -> {
            try {
                ...
                List<WebElement> checkLoadingIndicator = getActiveMobileDriver().findElements(By.xpath("//*[contains(@name,'Uploading...')]"));
