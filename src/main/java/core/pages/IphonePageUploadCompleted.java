...
public class IphonePageUploadCompleted extends IphoneCommonObjectsPage {
    @Override
    public void waitUntilLoadingIndicatorIsInvisible(int maxWaitTimeInSeconds) {
        ...
        webDriverWait.ignoring(StaleElementReferenceException.class).until(webDriver -> {
            try {
                ...
                List<WebElement> checkLoadingIndicator = getActiveMobileDriver().findElements(By.xpath("//*[contains(@name,'Processing')]"));
