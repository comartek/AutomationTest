...
public class PageUpLoadCompletedTablet extends AndroidMobileCommonObjectsPage {
    ...
    public void waitUntilLoadingIndicatorIsInvisible(int maxWaitTimeInSeconds) {
        ...
        webDriverWait.ignoring(StaleElementReferenceException.class).until(webDriver -> {
            try {
                ...
                List<WebElement> checkLoadingIndicator = getActiveMobileDriver().findElements(By.xpath("//android.widget.TextView[@text='Uploading...']"));
