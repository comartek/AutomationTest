...
@PageFactoryFinder(FindByVie.FindByBuilder.class)
public @interface FindByVie {
    ...
    class FindByBuilder extends AbstractFindByBuilder {
        ...
        public By buildIt(Object annotation, Field field) {
            FindByVie findByVie = (FindByVie)annotation;
            FindBy findBy = FindByUtils.castFindByVieToFindBy(findByVie);
